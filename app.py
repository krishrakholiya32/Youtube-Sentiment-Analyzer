...
# Streamlit Cloud: secrets stored in st.secrets. Local: .env via python-dotenv / system env.
GROQ_API_KEY = st.secrets.get("GROQ_API_KEY", os.getenv("GROQ_API_KEY"))
if not GROQ_API_KEY:
    st.error(
        "⚠️ Groq API key not set. "
        "Add `GROQ_API_KEY` to your Streamlit Cloud secrets or a local `.env` file. "
